...
const APP_ID = import.meta.env.VITE_APP_ID || 'app-8fsm78964c1t';
...
export const sendChatMessage = (messages: ChatMessage[]): EventSource => {
  const url = 'https://api-integrations.appmedo.com/app-8fsm78964c1t/api-rLob8RdzAOl9/v1beta/models/gemini-2.5-flash:streamGenerateContent?alt=sse';
...
export const sendChatMessageSync = async (messages: ChatMessage[]): Promise<ChatResponse> => {
  const url = 'https://api-integrations.appmedo.com/app-8fsm78964c1t/api-rLob8RdzAOl9/v1beta/models/gemini-2.5-flash:streamGenerateContent';
...
export const createTextToVideo = async (request: TextToVideoRequest): Promise<VideoTaskResponse> => {
  const url = 'https://api-integrations.appmedo.com/app-8fsm78964c1t/api-DY8MX5oBQDGa/v1/videos/text2video';
...
export const createImageToVideo = async (request: ImageToVideoRequest): Promise<VideoTaskResponse> => {
  const url = 'https://api-integrations.appmedo.com/app-8fsm78964c1t/api-6LeB8Qe4rWGY/v1/videos/image2video';
...
export const generateImage = async (request: ImageGenerationRequest): Promise<ImageGenerationResponse> => {
  const url = 'https://api-integrations.appmedo.com/app-8fsm78964c1t/api-Xa6JZ58oPMEa/v1beta/models/gemini-3-pro-image-preview:generateContent';
